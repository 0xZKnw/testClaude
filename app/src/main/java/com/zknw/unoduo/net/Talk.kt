...
object Talk {
    ...
    /**
     * The stickers, in the order the rail shows them. Sent as an index, never as text:
     * one byte on the wire, and a build that does not know a sticker simply ignores it
